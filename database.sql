...
(18, '网易云音乐信息获取', '网易云音乐信息获取', 'nemusic', 1, '{\n	\"code\": 500,\n	\"message\": \"success\",\n	\"data\": {\n		\"id\": \"760308\",\n		\"name\": \"Sayas Song\",\n		\"singer\": \"Lia\",\n		\"cover\": \"http://p1.music.126.net/kuT_f6Joy9LFzAWqdik1yw==/720180116205332.jpg\",\n		\"url\": \"http://music.163.com/song/media/outer/url?id=760308\"\n	}\n}', 'application/json', 'id&string&音乐ID|cover&string&音乐封面图片直链|name&string&音乐名字|singer&string&音乐歌手名字|url&string&音乐链接', '?msg=sayas song&line=1', 'GET/POST', 'msg&是&string&输内容|line&否&number&输内容的选择', NULL, '500&请求成功|501&错误', 0, '2022-10-03 08:09:02'),
...
(11, 'sexart_inside', 0, 'total'),
(13, 'uuidget_inside', 0, 'total'),
(15, 'lunar_inside', 0, 'total'),
(17, 'words_inside', 0, 'total'),
(19, 'fanyi_inside', 0, 'total'),
(21, 'base64_inside', 0, 'total'),
(23, 'beautyimg_inside', 0, 'total'),
(25, 'animeimg_inside', 0, 'total'),
(27, 'weather_inside', 0, 'total'),
(29, 'webtool_inside', 0, 'total'),
(31, 'riddle_inside', 0, 'total'),
(33, 'qqget_inside', 0, 'total'),
(35, 'nemusic_inside', 0, 'total'),
(37, 'motdpe_inside', 0, 'total'),
(39, 'nemusicdl_inside', 0, 'total'),
(41, 'hitokoto_ialapi_inside', 0, 'total'),
(43, 'index_hcb_inside', 0, 'total'),
(45, 'seimg_ialapi_inside', 0, 'total'),
(47, 'getbilianime_inside', 0, 'total'),
(49, 'idcard_inside', 0, 'total'),
(51, 'timecal_inside', 0, 'total'),
(53, 'diction_inside', 0, 'total'),
(55, 'reading_inside', 0, 'total'),
(57, 'chat_inside', 0, 'total'),
(59, 'sedimg_inside', 0, 'total'),
(61, 'sisters_inside', 0, 'total'),
(63, 'wall_inside', 0, 'total'),
(65, '60s_inside', 0, 'total'),
(67, 'storytoday_inside', 0, 'total'),
(69, 'nameidcard_inside', 0, 'total'),
(71, 'biligetv_inside', 0, 'total'),
(73, 'bilidlv_inside', 0, 'total'),
(75, 'stat_inside', 0, 'total'),
(77, 'qrcode_inside', 0, 'total'),
(79, 'cosimg_inside', 0, 'total'),
(81, 'biliget_inside', 0, 'total'),
(83, 'ipcard_inside', 0, 'total'),
(85, 'bing_inside', 0, 'total'),
(87, 'chr_inside', 0, 'total'),
(89, 'newyear_inside', 0, 'total'),
(91, 'starluck_inside', 0, 'total'),
(93, 'starpic_inside', 0, 'total'),
(95, 'component_inside', 0, 'total'),
(97, 'mirror_inside', 0, 'total'),
(99, 'covid_inside', 0, 'total'),
(101, 'sed_inside', 0, 'total'),
(103, 'sellerimg_inside', 0, 'total'),
(105, 'api_call_inside', 0, 'total'),
(115, 'web_visitor_inside', 0, 'total'),
(120, 'web_visit_inside', 0, 'total'),
(122, 'hitokoto_ialapi', 0, 'total'),
(124, 'seimg_ialapi', 0, 'total'),
(126, 'index_hcb', 0, 'total'),
...
(3, 'websubtitle', '', 'webinfo'),
(4, 'webdescr', '', 'webinfo'),
(5, 'keywords', '', 'webinfo'),
(6, 'author', 'Biyuehu', 'webinfo'),
(7, 'email', '@qq.com', 'webinfo'),
(8, 'createTime', '2021-6-19', 'webinfo'),
(9, 'theme', 'default', 'webinfo'),
(43, 'mainColor', 'pink', 'theme_default'),
(44, 'headUrl', 'Links,/friends|', 'theme_default'),
(45, 'tips', '', 'theme_default'),
(46, 'openEjct', '', 'theme_default'),
(47, 'openRoll', '', 'theme_default'),
(48, 'advert', '', 'theme_default'),
(49, 'bottom1', '', 'theme_default'),
(50, 'bottom2', '', 'theme_default'),
