...
(1, 'admin', 'admin@qq.com', '123456', 4, '', 2333, '2022-09-20 02:36:36');
...
INSERT INTO `huliapi_log` (`id`, `ua`, `url`, `request`, `ip`, `date`) VALUES
(1, '...', 'localhost', 'get', '127.0.0.1', '2023-07-15 03:53:12');
...
(5, 'keywords', '聚合数据,API数据接口,API', 'webinfo'),
(6, 'author', 'Himeno', 'webinfo'),
(7, 'email', 'admin@qq.com', 'webinfo'),
...
(49, 'bottom1', '<div style=\"color:lightgreen\">网站描述</div>', 'theme_default'),
...
(60, 'fromname', 'FoxHelperOne', 'plugins_email'),
(61, 'crossdomain', 'on', 'websafe'),
(62, 'cycle', '60', 'websafe'),
(63, 'cyclenum', '17', 'websafe'),
(64, 'refusemsg', '调用过于频繁请稍后再试', 'websafe'),
(65, 'badapimsg', '该接口正在维护中', 'websafe'),
(66, 'safeimport', 'nagisa', 'websafe'),
(67, 'accentColor', 'purple', 'theme_default'),
(68, 'log', '还没有更新日志', 'webinfo'),
(69, 'useropen', '用户中心公告', 'webinfo'),
(70, 'startcoin', '50', 'webinfo');
...
--
ALTER TABLE `huliapi_lib_stat`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=945;
