...
<head>
    ...
    <style type="text/css">
        .bg {
            background: #ecedf0 url("https://pic.imgdb.cn/item/63c64f40be43e0d30ebad817.png") fixed;
...
<body>
                ...
                <form id="j-validator" class="am-form am-margin-bottom-lg" method="post">
                    <div class="am-u-md-12 am-u-sm-centered">
                        ...
                        <div class="am-form-group">
                            <input autocomplete="off" id="j-input" data-filter="name" class="am-form-field am-input-lg am-text-center am-radius" placeholder="例如: 不要说话 陈奕迅" data-am-loading="{loadingText: ' '}" pattern="^.+$" required>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;<?php echo date('Y'); ?>&nbsp<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}"><br></a></p>
    </footer>
