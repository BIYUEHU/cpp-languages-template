...
$login=new qq_login();
if($_GET['do']=='checkvc'){
	$array=$login->checkvc($_POST['uin'],$_POST['tokenid']);
}
elseif($_GET['do']=='dovc'){
	$array=$login->dovc($_POST['uin'],$_POST['sig'],$_POST['ans'],$_POST['cap_cd'],$_POST['sess'],$_POST['collectname'],$_POST['websig'],$_POST['cdata'],$_POST['sid']);
}
elseif($_GET['do']=='getvc'){
	$array=$login->getvc($_POST['uin'],$_POST['sig'],$_POST['sess'],$_POST['sid'],$_POST['websig']);
}
elseif($_GET['do']=='qqlogin'){
	$array=$login->qqlogin($_POST['uin'],$_POST['pwd'],$_POST['p'],$_POST['vcode'],$_POST['pt_verifysession'],$_POST['cookie'],$_POST['sms_code'],$_POST['sms_ticket']);
}
