...
class qq_login{
	...
	public function qqlogin($uin,$pwd,$p,$vcode,$pt_verifysession,$cookie,$sms_code=null,$sms_ticket=null){
		if(empty($uin))return array('saveOK'=>-1,'msg'=>'QQ不能为空');
	...
	public function getvc($uin,$sig,$sess,$sid,$websig){
		...
		if($sess=='0'){
			$url='https://t.captcha.qq.com/cap_union_prehandle?aid=549000912&captype=&protocol=https&clientype=2&disturblevel=&apptype=2&noheader=0&color=&showtype=&fb=1&theme=&lang=2052&ua='.urlencode(base64_encode($this->ua)).'&grayscale=1&cap_cd='.$sig.'&uid='.$uin.'&subsid=1&callback=&sess=';
