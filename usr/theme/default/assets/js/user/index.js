...
function doRegister() {
  ...
  sendPostRequest(location.href, data, (d) => {
    switch (d.code) {
      case 500:
        layer.alert(
          "请查看您的邮箱信件获取登录密码,如若找不邮件请查看垃圾邮箱或检查邮箱是否正确",
          {
            icon: 6,
            shadeClose: true,
            title: "注册成功",
...
function apishop() {
  ...
  table.on("tool(nowline)", (obj) => {
    switch (obj.event) {
      case "buy":
        layer.confirm(
          `确定要花费<span class="set-accent-color">${obj.data.coin} Coin</span>购买吗?`,
          {
            icon: 3,
            title: "提示",
          },
            ...
            sendPostRequest("./apishopbuy", data, (d) => {
              switch (d.code) {
                case 500:
                  layer.close(index);
                  layer.msg(
                    '购买成功<br><a href="./apilist" class="set-accent-color">点击跳转</a>'
                  );
                  break;
                case 502:
                  layer.close(index);
...
function apiadd() {
  form.on("submit(apiadd)", (obj) => {
    ...
    try {
      if (
        objData["pars0_0_name"] != "" &&
        objData["pars0_0_type"] != "" &&
        objData["pars0_0_descr"] != ""
      ) {
        returnpar = `${objData["pars0_0_name"]}&${objData["pars0_0_type"]}&${objData["pars0_0_descr"]}`;
        let pars0Id = 1;
        while (
          objData[`pars0_${pars0Id}_name`] != "" &&
          typeof objData[`pars0_${pars0Id}_name`] == "string"
        ) {
          if (
            objData[`pars0_${pars0Id}_name`] != "" &&
            objData[`pars0_${pars0Id}_type`] != "" &&
            objData[`pars0_${pars0Id}_descr`] != ""
          ) {
            returnpar += `|${objData[`pars0_${pars0Id}_name`]}&${
              objData[`pars0_${pars0Id}_type`]
            }&${objData[`pars0_${pars0Id}_descr`]}`;
          }
          pars0Id++;
      ...
      if (
        objData["pars1_0_name"] != "" &&
        objData["pars1_0_if"] != "" &&
        objData["pars1_0_type"] != "" &&
        objData["pars1_0_descr"] != ""
      ) {
        requestpar = `${objData["pars1_0_name"]}&${objData["pars1_0_if"]}&${objData["pars1_0_type"]}&${objData["pars1_0_descr"]}`;

        let pars1Id = 1;
        while (
          objData[`pars1_${pars1Id}_name`] != "" &&
          typeof objData[`pars1_${pars1Id}_name`] == "string"
        ) {
          if (
            objData[`pars1_${pars1Id}_name`] != "" &&
            objData[`pars1_${pars1Id}_if`] != "" &&
            objData[`pars1_${pars1Id}_type`] != "" &&
            objData[`pars1_${pars1Id}_descr`] != ""
          ) {
            requestpar += `|${objData[`pars1_${pars1Id}_name`]}&${
              objData[`pars1_${pars1Id}_if`]
            }&${objData[`pars1_${pars1Id}_type`]}&${
              objData[`pars1_${pars1Id}_descr`]
            }`;
      ...
      if (objData["pars2_0_name"] != "" && objData["pars2_0_descr"] != "") {
        ...
        let pars2Id = 1;
        while (
          objData[`pars2_${pars2Id}_name`] != "" &&
          typeof objData[`pars2_${pars2Id}_name`] == "string"
        ) {
          if (
            objData[`pars2_${pars2Id}_name`] != "" &&
            objData[`pars2_${pars2Id}_descr`] != ""
          ) {
            codepar += `|${objData[`pars2_${pars2Id}_name`]}&${
              objData[`pars2_${pars2Id}_descr`]
            }`;
          }
          pars2Id++;
    ...
    cols: [
      [
        ...
        },
        {
          title: "返回示例",
          templet: (d) => {
            return d.returnTemp == 0 || d.returnTemp == "0"
              ? '<span style="color:blue">网页</span>'
              : d.returnTemp;
          },
        },
        {
                                ...
                                }, */
        {
          title: "返回参数",
          templet: (d) => {
            return d.returnPar == null
              ? '<span style="color:red">无</span>'
              : JSON.stringify(d.returnPar);
          },
        },
        {
          title: "请求参数",
          templet: (d) => {
            return d.requestPar == null
              ? '<span style="color:red">无</span>'
              : JSON.stringify(d.requestPar);
          },
        },
        {
          title: "状态码",
          templet: (d) => {
            return d.codePar == null
              ? '<span style="color:red">无</span>'
              : JSON.stringify(d.codePar);
          },
        },
        {
          field: "coin",
